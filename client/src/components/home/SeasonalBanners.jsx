    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-[#CFDFE8] p-8 sm:p-10 flex flex-col justify-between min-h-[260px] sm:min-h-[280px] text-neutral-900 shadow-sm"
        >
          {/* Left Content */}
        ...
        <motion.div
          whileHover={{ y: -3 }}
          transition={{ duration: 0.25 }}
          className="relative overflow-hidden rounded-3xl bg-[#E8DFD5] p-8 sm:p-10 flex flex-col justify-between min-h-[260px] sm:min-h-[280px] text-neutral-900 shadow-sm"
        >
          {/* Left Content */}
          <div className="relative z-10 max-w-[55%] flex flex-col items-start">
            <span className="text-[11px] font-bold uppercase tracking-wider text-neutral-600 mb-2">
