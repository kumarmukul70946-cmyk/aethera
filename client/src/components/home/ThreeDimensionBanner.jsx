...
export default function ThreeDimensionBanner() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#EAE7F6] via-[#EFEBF8] to-[#F6F3FB] border border-[#E4DFFA]/60 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between min-h-[220px] shadow-sm">
        {/* Left Content */}
        <div className="relative z-10 max-w-md text-left mb-6 md:mb-0">
          ...
          <Link
            to="/3d-lab"
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-neutral-900 text-white text-xs font-semibold hover:bg-neutral-800 transition shadow-sm"
          >
        ...
        {/* Right 3D Visual with floating spheres and sneaker */}
        <div className="relative w-full md:w-[48%] h-48 sm:h-56 flex items-center justify-center md:justify-end overflow-hidden">
          ...
          {/* Floating 3D Sneaker Graphic */}
          <motion.img
            whileHover={{ scale: 1.05, rotate: -2 }}
            src="/images/showcase_sneaker.jpg"
            alt="3D Interactive Sneaker"
            className="relative z-10 max-h-48 w-auto object-contain drop-shadow-xl rounded-2xl"
          />
        </div>
      </div>
    </section>
