...
/**
 * Standardized SVG Icons for Aethera Commerce.
 * Styled cleanly with currentColor and customizable size/stroke.
 */
...
export const HeartIcon = ({ className = "w-5 h-5", filled = false, ...props }) => (
  <svg
    className={className}
...
export const StarIcon = ({ className = "w-4 h-4", filled = true, ...props }) => (
  <svg
    className={className}
    fill={filled ? "currentColor" : "none"}
    viewBox="0 0 24 24"
...
export const SlidersIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const RotateCcwIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export const CubeIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
